...
public class MainWrapper {
  ...
  public static void ex03() {
    ...
    // 배열의 선언 & 생성
    int[] a = new int[5];   // 배열의 필드값 중 length를 호출하면 배열의 길이(배열에 저장하기로 한 변수의 갯수)를 알아낼 수 있다.
    
    // 배열의 순회
    // 배열의 길이는 "배열명.length"로 알아낼 수 있다.
    for(int i = 0; i < a.length; i++) {   // 인덱스의 값을 0 세팅
      System.out.println(a[i]);
    }
    // 인덱스의 변수명 : i, j, k -->개발자 사이 암묵적 약속
