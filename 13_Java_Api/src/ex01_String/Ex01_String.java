...
public class Ex01_String {
  ...
  public static void ex03() {
    ...
    boolean isEqual1 = name1.equals(name2);  // "tom"과 "tom" 문자열 비교
    ...
    boolean isEqual3 = name1.equalsIgnoreCase(name3);   // 대소문자를 무시하고 문자열을 비교 (Case : upper case, lower case)
    System.out.println(isEqual3);  // true
  }
  
  // upperCase / lowerCase (대소문자 변환 메소드)
  ...
  // 중요! substring (특정 문자열의 일부만 반환하는 메소드)
