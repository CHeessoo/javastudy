...
public class MainWrapper {
  ...
  public static void ex06() {
    ...
    System.out.println("당신은 " + rsp[user] + " 컴퓨터는 " + rsp[com] + ", 당신은 " + result);
    sc.close();
  }
  ...
  public static void ex07() {
    ...
    for(int n = 0; n < count; n++) {  // count만큼 반복하기
      ...
      if(randomNumber < 0.33) {
        sb.append(secureRandom.nextInt(10));   // int값 0~9
      } else if(randomNumber < 0.66) {
        sb.append((char)(secureRandom.nextInt(26) + 'A'));  // 대문자 랜덤
      } else {
        sb.append((char)(secureRandom.nextInt(26) + 'a'));  // 소문자 랜덤
      }
    } 
