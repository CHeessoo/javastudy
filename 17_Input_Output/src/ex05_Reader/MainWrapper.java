...
public class MainWrapper {
  ...
  public static void ex03() {
    ...
    // 버퍼입력스트림 선언
    BufferedReader br = null; // 문자를 읽을 땐 BufferedReader가 굉장히 유용하다.
  ...
  public static void ex04() {
    ...
    try {
      ...
      while((line = br.readLine()) != null) {
        sb.append(line + "\n"); // 원본에 줄 바꿈이 없어서 "안녕하세요Hello"로 출력된다.
      }
      System.out.println(sb.toString());
      br.close();
    } catch (IOException e) {
...
// ex03() 파일리더는 스트링을 반환할수없다.....? - 1교시 녹ㅎ음 확인해서 다시 정리