...
public class MainWrapper {
  ...
  public static void ex01() {
     ...
     *       1) 프로토콜   : 통신규약, https(secure + http : 보안 처리된 하이퍼텍스트 전송 프로토콜) (하이퍼텍스트 = HTML)
     *       2) 호스트     : 서버주소
     *       3) URLMapping : 서버경로
     *       4) 파라미터   : 서버로 보내는 데이터
     */
    //          포트번호   : 통신을 위해서 약속된 포트를 전하고 해당 포트번호를 적는 형식(기본 포트번호는 생략이 가능하다.) - 2교시 녹화 보고 다시 정리
  ...
  public static void ex02() {
    ...
    try {
      ...
      String requestMethod = con.getRequestMethod();  // RequestMethod: GET
  ...
  public static void ex03() {
    ...
    // 출력스트림 선언 (C:/storage/banner.jpeg 파일은 만드는 스트림)
