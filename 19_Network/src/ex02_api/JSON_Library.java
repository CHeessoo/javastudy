...
public class JSON_Library {
  ...
  public static void ex03() {
    ...
    String str = "{\"name\":\"tom\",\"age\":50,\"height\":190.5}";    // ex01 호출내역 복사해서 붙여넣음
    
    // String -> JSONObject 객체로 변환
    JSONObject obj = new JSONObject(str);
    
    // 원하는 Key(Property)를 가져오기
    String name = obj.getString("name");      // String name = (String)obj.get("name"); Map 기반이기 때문에 get메소드 이용해서 원하는 타입으로 casting해서 사용하는것도 가능하지만 권장하진 않는다.
