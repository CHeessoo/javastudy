...
//	  System.out.println("여자입니다.");
	...
	public static void q11() {
		...
		System.out.println("모든 " + target + "의 배수 합은 " + total + "입니다.");
	}
	...
	public static void q14() {
		...
		String gift = "";   // String gift = null;  --> 문자열을 연결할 땐 null을 쓰면 null도 문자열 값에 같이 연결되어 출력됨.
		...
		System.out.println(score + "점의 사은품은 " + gift + "입니다.");
		
		
		// 의도적으로 break문을 사용하지 않은 switch문 사용 예시 (답은 아님. 순서가 거꾸로 나옴)
		/*
		switch (score / 10) {
    case 10:
    case 9: gift += "냄비";
